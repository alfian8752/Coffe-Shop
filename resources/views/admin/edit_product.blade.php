        ...
        <div class="row">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                ...
                <div class="tambah-produk">
                    <form class="div" action="/edit-produk-{{ $product->id }}" method="post" enctype="multipart/form-data">
                        @csrf
                        <div class="gambar">
                            <input type="file" id="gambar" name="gambar" accept="image/*">
                            <img id="previewGambar" src="/image-uploads/{{ $product->gambar }}" alt="Pratinjau Gambar">
                        </div>
